 ...
 * @date 2024-07-01
 */
public class ApiExceptionMonitorWeworkAlertListener extends AbstractApiMonitorWeworkAlertListener<ApiExceptionAlertDTO> {

    public ApiExceptionMonitorWeworkAlertListener(WeworkRobotAgent weworkRobotAgent, ApiMonitorProperties apiMonitorProperties, IMessageFactory<ApiExceptionAlertDTO> messageFactory) {
        super(weworkRobotAgent, apiMonitorProperties, messageFactory);
    }

    @Override
    protected String getRobotKey() {
        return apiMonitorProperties.getExceptionApiRobotKey();
    }
