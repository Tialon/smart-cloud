 ...
 */
package io.github.smart.cloud.starter.log.mask.jackson;
...
import io.github.smart.cloud.starter.log.mask.jackson.annotation.MaskLog;
import io.github.smart.cloud.starter.log.mask.jackson.enums.MaskRule;
import io.github.smart.cloud.starter.log.mask.jackson.util.MaskUtil;
...
public class MaskJsonSerializer extends JsonSerializer<Object> implements ContextualSerializer {
    ...
    private boolean isSetMaskAttributes(MaskLog maskLog) {
        return maskLog.startLen() != LogMaskConstants.START_LEN || maskLog.endLen() != LogMaskConstants.END_LEN
                || !LogMaskConstants.MASK_VALUE.equals(maskLog.mask());
    }
